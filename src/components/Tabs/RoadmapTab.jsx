...
import { MessageCircle, Zap, Trophy, Pen, Check, Lock, BookOpen, Music, Landmark } from 'lucide-react';
...
const NODE_STYLES = {
    ...
    green:  { color: '#06D6A0', dark: '#05A67D', bg: 'rgba(6,214,160,0.12)', muted: 'rgba(6,214,160,0.35)', mutedBorder: 'rgba(6,214,160,0.25)', mutedIcon: 'rgba(6,214,160,0.5)', icon: Landmark, label: 'Scene' },
    ...
    gold:   { color: '#F59E0B', dark: '#D97706', bg: 'rgba(245,158,11,0.12)', muted: 'rgba(245,158,11,0.35)', mutedBorder: 'rgba(245,158,11,0.25)', mutedIcon: 'rgba(245,158,11,0.5)', icon: Landmark, label: 'Scene' },
};
