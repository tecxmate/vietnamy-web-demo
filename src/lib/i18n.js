...
const en = {
    ...
    visible_languages: 'Visible Languages',
...
const fr = {
    ...
    tts_speed: 'Vitesse TTS', display: 'Affichage', font_size: 'Taille de police', reminders: 'Rappels', daily_reminder: 'Rappel quotidien',
...
const it = {
    ...
    tts_speed: 'Velocità TTS', display: 'Visualizzazione', font_size: 'Dimensione carattere', reminders: 'Promemoria', daily_reminder: 'Promemoria giornaliero',
...
const es = {
    ...
    tts_speed: 'Velocidad TTS', display: 'Pantalla', font_size: 'Tamaño de fuente', reminders: 'Recordatorios', daily_reminder: 'Recordatorio diario',
