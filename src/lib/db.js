...
const INIT_DATA = {
    ...
    path_nodes: [
        ...
        { id: "p3_SC1", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 9, node_type: "scene", module_type: "green", label: "☕ At the Café", scene_id: "scene_cafe_001", difficulty: 7, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_T" }] } },
...
const CURRICULUM_VERSION = 8; // bump when units/path_nodes change (v8: scene nodes green, v7: CEFR/difficulty/vocab metadata)
const initDB = () => {
