...
const DB_KEY = 'vnme_mock_db_v14'; // v14: add CEFR/difficulty/vocab metadata to path_nodes, restructure Unit 1 // v13: distribute grammar units as purple path_nodes
...
const INIT_DATA = {
    ...
    path_nodes: [
        // ═══ Unit 1: First Words ═══
        // Greetings + basic intro + textbook flow: Conversation → Quiz → Grammar → Pronunciation
        ...
        { id: "p3_L006", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 4, node_type: "lesson", module_type: "orange", lesson_id: "lesson_006", difficulty: 6, cefr_level: "A1.2", vocab_introduces: ["it_w_0040", "it_w_0041", "it_w_0042", "it_w_0043", "it_s_0044"], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_S1" }] } },
        { id: "p3_Q006", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 5, node_type: "test", module_type: "orange", label: "Café Quiz", test_scope: "module", source_node_id: "p3_L006", difficulty: 6, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_L006" }] } },
        { id: "p3_G1", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 6, node_type: "skill", module_type: "purple", label: "Grammar: Want to (muốn)", skill_content: { type: "grammar_unit", grammar_unit_id: "A1_M25_U01" }, difficulty: 4, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: ["it_w_0035", "it_w_0030", "it_w_0031", "it_w_0032"], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_Q006" }] } },
        { id: "p3_S3", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 7, node_type: "skill", module_type: "purple", label: "Classifiers: Basics", skill_content: { type: "practice_module", route: "/practice/classifiers-1" }, difficulty: 4, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_G1" }] } },
        { id: "p3_T", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 8, node_type: "test", module_type: "test", label: "Unit 3 Test", test_scope: "unit", difficulty: 7, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_S3" }] } },
        { id: "p3_SC1", course_id: "course_vi_en_v1", unit_id: "phase_3_cafe", node_index: 9, node_type: "scene", module_type: "gold", label: "☕ At the Café", scene_id: "scene_cafe_001", difficulty: 7, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p3_T" }] } },
        ...
        { id: "p4_S3", course_id: "course_vi_en_v1", unit_id: "phase_4_food", node_index: 7, node_type: "skill", module_type: "green", label: "Numbers: 11–99", skill_content: { type: "practice_module", route: "/practice/numbers-2" }, difficulty: 5, cefr_level: "A1.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p4_S2" }] } },
        ...
        { id: "p5_S4", course_id: "course_vi_en_v1", unit_id: "phase_5_market", node_index: 10, node_type: "skill", module_type: "green", label: "Prepositions", skill_content: { type: "practice_module", route: "/practice/prepositions" }, difficulty: 5, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p5_S3" }] } },
        ...
        { id: "p6_S2", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 8, node_type: "skill", module_type: "blue", label: "Vowels: Gliding Diph.", skill_content: { type: "practice_module", route: "/practice/vowels-diph-2" }, difficulty: 5, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p6_G1" }] } },
        { id: "p6_S3", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 9, node_type: "skill", module_type: "blue", label: "Pitch: Easy Tones", skill_content: { type: "practice_module", route: "/practice/pitch-1" }, difficulty: 4, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p6_S2" }] } },
        { id: "p6_S4", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 10, node_type: "skill", module_type: "purple", label: "Quantifiers", skill_content: { type: "practice_module", route: "/practice/quantifiers" }, difficulty: 5, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p6_S3" }] } },
        { id: "p6_T", course_id: "course_vi_en_v1", unit_id: "phase_6_numbers", node_index: 11, node_type: "test", module_type: "test", label: "Unit 6 Test", test_scope: "unit", difficulty: 8, cefr_level: "A1.3", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p6_S4" }] } },
        ...
        { id: "p9_S7", course_id: "course_vi_en_v1", unit_id: "phase_9_social", node_index: 15, node_type: "skill", module_type: "green", label: "Degree Adverbs", skill_content: { type: "practice_module", route: "/practice/degree-adverbs" }, difficulty: 7, cefr_level: "A2.2", vocab_introduces: [], vocab_requires: [], unlock_rule: { requires: [{ type: "node_completed", node_id: "p9_S6" }] } },
...
const CURRICULUM_VERSION = 7; // bump when units/path_nodes change (v7: CEFR/difficulty/vocab metadata, Unit 1 restructure)
const initDB = () => {
